...
public final class XmlUtil {
	...
	public static void main(String[] args) throws Exception {
		String xmlStr = "<Head><serviceCode ID ='wms'>0016</serviceCode><serviceDesc>hello</serviceDesc><clientRunningNum>1504681111172</clientRunningNum><partnerID>YD12580</partnerID><userID>YD12580</userID><timeStamp>2017-11-01 14:58:31</timeStamp><servicePassword>xyz</servicePassword><serverRunningNum>1504681111172</serverRunningNum><resultCode></resultCode><resultMessage></resultMessage></Head>";
		Document rootDocument = DocumentHelper.parseText(xmlStr);
		Element rootElement = rootDocument.getRootElement();
		System.out.println(rootDocument.elementByID("wms").getName());
		//System.out.println(rootElement);
		
		
		Map parseXml2Map = parseXml2Map(xmlStr);
