 ...
 *
 */
public class AppCommonConst {
	// 定义了数据字面值 select csz from gy_xtcs where csmc='SET_YYGH_JSON';
	public final static String PARAM_VALUE = "SET_YYGH_JSON";
	...
	public static final String SYSTEM_HAND_PROCEDURE_NAME_SAVE_BILLCHARGE_PRE = hand_pack
			+ "BSHIS_app_saveBillCharge_pre";// 获取费用预结算金额
