...
public class IDCardUtils {
     ...
     * @return
     */
    public static boolean cardCodeVerifySimple18(String cardcode) {
        // 第二代身份证正则表达式(18位)
        String isIDCard2 = "^[1-9]\\d{5}[1-9]\\d{3}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])((\\d{4})|\\d{3}[A-Z,a-z])$";
